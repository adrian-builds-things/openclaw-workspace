...
| **"Expired Worthless" + Close Type dropdown** (QW-2 + QW-5) | Enes | ~1 day | Win rate and P&L wrong for all income traders. Combinable into one story. | [SPEC-03](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-03-option-lifecycle-actions.md) |
| **Default Transaction Fees** (QW-3) | Enes | 1–2 days | P&L accuracy for all existing users. Popup on Trade Details page. | [SPEC-DEFAULT-FEES](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-DEFAULT-FEES.md) |
...
| **Trade Management Tool — multi-leg fix** (QW-6) | Enes | 1–2 days | SL/TP calculator currently wrong for spreads, condors, strangles. Net debit/credit and spread width not correctly aggregated. Silently wrong numbers for every multi-leg user. | [SPEC-TRADE-MANAGEMENT](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-TRADE-MANAGEMENT.md) |
...
| Item | Owner | Effort | Notes | Spec |
|------|-------|--------|-------|------|
| **Stock Support** (SPEC-01) | Enes | 1–2 weeks | Foundation for Trade Bundles and Custom Strategy Types. Needs DB Cleanup from Sprint 1. If Enes has capacity after Sprint 1, start early. | [SPEC-01](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-01-stock-support.md) |
...
| Item | Owner | Effort | Notes | Spec |
|------|-------|--------|-------|------|
| **Stock Support** (SPEC-01) | Enes | 1–2 weeks | If not finished in Sprint 2. | [SPEC-01](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-01-stock-support.md) |
| **Trade Management Tool — stock extension** | Enes | 1–2 days | Extend SL/TP calculator to handle stock positions (price-based, not premium-based). Also: blended P&L view for Wheel/Covered Call (stock leg + options leg combined). Ships immediately after SPEC-01. | [SPEC-TRADE-MANAGEMENT](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-TRADE-MANAGEMENT.md) |
| **Trade Bundles** (SPEC-02) | Enes | 2–3 weeks | Levi precondition #1. Pietro's core request. 12+ users. Cannot start before SPEC-01. | [SPEC-02](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-02-trade-bundles.md) |
...
| Item | Owner | Effort | Notes | Spec |
|------|-------|--------|-------|------|
| **Per-Leg Closing + Roll + Assignment** (SPEC-03) | Enes | 1–2 weeks | Levi precondition #2. Per-Leg Closing is the hard blocker. Roll and Assignment complete the income trader picture. | [SPEC-03](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-03-option-lifecycle-actions.md) |
...
| Item | Owner | Effort | Notes | Spec |
|------|-------|--------|-------|------|
| **Custom Strategy Builder** (SPEC-04) | Enes | 2–4 weeks | Needs SPEC-01 + SPEC-02 + SPEC-03. Full foundation must be in place first. | [SPEC-04](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-04-custom-strategy-builder.md) |
...
| **Public Roadmap + Feature Voting** | Enes | 1–2 weeks | Community investment, reduces "why isn't X built yet?" friction. | [SPEC-ROADMAP](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-PUBLIC-ROADMAP-VOTING.md) |
...
| **Documentation — Tier 1 content** (G7) | Eve (content) + Adrian (review) | Core workflow pages in German + English. No Enes dependency if using Mintlify/GitBook subdomain. Can run in parallel with tech work. See [SPEC-DOCUMENTATION](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-DOCUMENTATION.md). |
