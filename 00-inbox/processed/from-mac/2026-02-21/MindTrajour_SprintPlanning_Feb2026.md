...
> **Roadmap:** [→ View full roadmap (Now / Next / Later)](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/ROADMAP.md) · [→ Quick Wins checklist](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/QUICK-WINS.md)
...
|------|------|--------|------|
| SPEC-01 | Stock Support | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-01-stock-support.md) |
| SPEC-02 | Trade Bundles | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-02-trade-bundles.md) |
| SPEC-03 | Option Lifecycle Actions | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-03-option-lifecycle-actions.md) |
| SPEC-04 | Custom Strategy Builder | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-04-custom-strategy-builder.md) |
| SPEC-DEFAULT-FEES | Default Transaction Fees | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-DEFAULT-FEES.md) |
| SPEC-GROWTH-KR | Keyword Research | In Progress | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-keyword-research.md) |
| SPEC-GROWTH-SEO | SEO Strategy | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-seo.md) |
| SPEC-GROWTH-ADS | Google Ads Prerequisites | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-google-ads-prerequisites.md) |
| SPEC-ROADMAP | Public Roadmap & Feature Voting | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-PUBLIC-ROADMAP-VOTING.md) |
| SPEC-CHANGELOG | Automated Changelog System | Implemented | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-CHANGELOG.md) |
| SPEC-DOCUMENTATION | Feature Documentation & SEO Knowledge Base | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-DOCUMENTATION.md) |
| SPEC-TRADE-MANAGEMENT | Trade Management Tool (SL/TP Calculator) | Draft | [→ Open](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-TRADE-MANAGEMENT.md) |

---

## ⚡ Quick Wins

> **[→ Open Quick Wins Overview](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/QUICK-WINS.md)** — 7 stories, all shippable independently, < 2 days each. Includes the Shortcut story checklist.
...
**Why it is its own block:** Keyword Research has no upstream dependencies of its own, but two otherwise independent specs both depend on it — [SPEC-GROWTH-seo.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-seo.md) (Technical SEO meta copy, Organic Content topics) and [SPEC-GROWTH-google-ads-prerequisites.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-google-ads-prerequisites.md) (Landing Page Copy, Ad-Specific LPs). This shared dependency is the structural proof that Keyword Research is a standalone deliverable, not a subtask of either spec.

**Owner:** Larissa + Eve
**Status:** A preliminary cluster list exists. Full prioritization with search volume + competition data is pending.

**Tool:** `marketing:seo-audit` skill (Cowork) can execute this automatically — provides keyword research, on-page analysis, content gap analysis, and competitor comparison. See [SPEC-GROWTH-keyword-research.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-keyword-research.md) for full details and execution instructions.

**See [SPEC-GROWTH-keyword-research.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-keyword-research.md)** for deliverable definition, keyword clusters, and open questions.
...
**The two workstreams (see [SPEC-GROWTH-seo.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-seo.md) for details):**
...
**Dependency:** Keyword Research (above) → Technical SEO → Google Ads launch. See [SPEC-GROWTH-seo.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-seo.md).
...
**The four workstreams (see [SPEC-GROWTH-google-ads-prerequisites.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-google-ads-prerequisites.md) for details):**
...
Business-centric event architecture — 5 Customer Events (milestones) + 6 Product Events (flow analysis) + 1 Interaction Event. Full event table with parameters and cardinality warnings in [SPEC-GROWTH-google-ads-prerequisites.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-google-ads-prerequisites.md).
...
| Changelog | Users always know what changed in the app — builds trust and reduces confusion after updates. See [SPEC-CHANGELOG.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-CHANGELOG.md) |
| Public Roadmap + Feature Voting | Transparency toward users: upcoming features visible, users can vote on priorities, see what's in progress. Reduces "why isn't X built yet?" friction and creates community investment in the product direction. Data stored in Supabase. See [SPEC-PUBLIC-ROADMAP-VOTING.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-PUBLIC-ROADMAP-VOTING.md) |
| Organic SEO Content Strategy | Keyword Research + Technical SEO are Google Ads prerequisites (see 🔴 SEO block above). The longer-horizon layer is organic content: blog posts targeting keyword clusters (strategy guides, comparison articles), backlink building, and ongoing refinement. Goal: reduce CAC by shifting from paid to organic over time. Documented in [SPEC-GROWTH-seo.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-seo.md), Workstream 3. |
...
| 2 | Keyword Research: complete prioritized list with volume + competition data — or run `marketing:seo-audit` skill (see [SPEC-GROWTH-keyword-research.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-keyword-research.md)) | Larissa + Eve | Before Technical SEO |
| 3 | SEO: Technical SEO — meta titles, descriptions, Core Web Vitals, structured data (see [SPEC-GROWTH-seo.md](computer:///sessions/eager-elegant-heisenberg/mnt/outputs/specs/SPEC-GROWTH-seo.md)) | Enes (implementation) + Eve (strategy) | After keyword research (#2) |
